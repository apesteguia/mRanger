    ...
    def __init__(self, rootDir: str = ''):
        ...
        if not rootDir:
            ...
            if os.path.exists(rootDir) and os.path.isdir(rootDir):
                ...
                raise ValueError("The specified root directory does not exist or is not a directory.")
    ...
    def current_folders(self):
        if not self.current_dir:
            ...
            if os.path.exists(self.current_dir) and os.path.isdir(self.current_dir):
                self.dir_items = [d for d in os.listdir(self.current_dir) if os.path.isdir(os.path.join(self.current_dir, d))]
            else:
    ...
    def secondary_folders(self, path: str):
        if not path:
            ...
            if os.path.exists(path) and os.path.isdir(path):
                self.sub_dir_items = [d for d in os.listdir(path) if os.path.isdir(os.path.join(path, d))]
            else:
